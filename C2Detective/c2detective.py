...
def main():
    ...
    #             print(
    #                 f"[{time.strftime('%H:%M:%S')}] [INFO] It is recommended to update the Tor node list every 30 minutes (use '-utn' next time)")
    ...
    #     else:
    #         print(
    #             f"[{time.strftime('%H:%M:%S')}] [ERROR] Required file '{file_path}' does not exist (use '-utn' next time)")
    ...
    #         # crypto domain names list was not updated in the last 24 hours
    #         if not time_diff < 24 * 60 * 60:
    #             print(
    #                 f"[{time.strftime('%H:%M:%S')}] [INFO] It is recommended to update the crypto / cryptojacking based sites list every 24 hours (use '-ucd' next time)")
    #             logging.info(
    #                 f"It is recommended to update the crypto / cryptojacking based sites list every 24 hours (use '-ucd' next time)")
    #         else:
    ...
    #     else:
    #         print(
    #             f"[{time.strftime('%H:%M:%S')}] [ERROR] Required file '{file_path}' does not exist (use '-ucd' next time)")
    ...
    #         if not time_diff < 24 * 60 * 60:
    #             print(
    #                 f"[{time.strftime('%H:%M:%S')}] [INFO] It is recommended to update the Proofpoint Emerging Threats JA3 rules every 24 hours (use '-ujr' next time)")
    #             logging.info(
    #                 f"It is recommended to update the Proofpoint Emerging Threats JA3 rules every 24 hours (use '-ujr' next time)")
    #         else:
    ...
    #     else:
    #         print(
    #             f"[{time.strftime('%H:%M:%S')}] [ERROR] Required file '{file_path}' does not exist (use '-ujr' next time)")
    ...
    if plugins:
        ...
        print("without C2Hunter; with DGA detection")
        c2_indicators_total_count = 10
        plugin_c2hunter = False
        dga_detection = True
    else:  # without C2Hunter; without DGA detection
        print("without C2Hunter; without DGA detection")
